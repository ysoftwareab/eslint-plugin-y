let {saneRequire} = require('../configs/util');

// eslint-disable-next-line complexity
let isNodeOnlyParamObject = function(node) {
  let isArgument =
...
let astUtils = saneRequire('eslint/lib/rules/utils/ast-utils');

module.exports = {
  astUtils,
  isNodeOnlyParamObject
};
